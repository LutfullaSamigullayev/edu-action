    ...
    <section className="container_">
      <div className="relative w-full h-60 sm:h-96 md:h-[440px] lg:h-[600px] xl:h-[716px] rounded-lg overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 p-20 text-white">
          <h3 className="hidden md:block w-3/5 h-fit font-semibold text-4xl lg:text-5xl xl:text-6xl mb-8 leading-[80px]">
            {t("title")}
          </h3>
          <div className="w-full sm:w-4/5 md:w-3/5 lg:w-2/5 flex items-center justify-between gap-x-3 sm:gap-x-4 md:gap-x-5 lg:gap-x-6">
